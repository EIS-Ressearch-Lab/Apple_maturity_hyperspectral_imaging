...
#     # # Convolutional Block 5
#     # model_complex_firmness.add(Conv2D(1024, kernel_size=(1, 1), activation="relu"))
#     # model_complex_firmness.add(BatchNormalization())
#     # model_complex_firmness.add(MaxPooling2D(pool_size=(1, 1), strides=(1,1), padding = 'same'))
#     # model_complex_firmness.add(Dropout(0.25))
...
#     )
#     model_complex_firmness.add(BatchNormalization())
#     model_complex_firmness.add(MaxPooling2D(pool_size=(1, 1), strides=(1,1), padding='same')) # cuts image in half
...
train_generator = data_generator_w_cultivar(X_train_Firmness, Y_train_Firmness, Frmness_encoder_shuffled, batch_size, img_size)
val_generator = data_generator_w_cultivar(X_validate_Firmness, Y_validate_Firmness, validate_encoder, batch_size, img_size)
