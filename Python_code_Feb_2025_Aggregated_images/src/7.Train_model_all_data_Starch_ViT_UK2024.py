...
X_train_Starch          = np.load(f'{training_data_path}X_train_UK2024_Starch_shuffled.npy')
Y_train_Starch          = np.load(f'{training_data_path}Y_train_UK2024_Starch_shuffled.npy')
X_validate_Starch       = np.load(f'{training_data_path}X_validate_UK2024_Starch_shuffled.npy')
Y_validate_Starch       = np.load(f'{training_data_path}Y_validate_UK2024_Starch_shuffled.npy')
Frmness_encoder_shuffled  = np.load(f'{training_data_path}X_train_UK2024_Starch_encoder_shuffled.npy')
validate_encoder        = np.load(f'{training_data_path}X_validate_UK2024_Starch_encoder_shuffled.npy')
