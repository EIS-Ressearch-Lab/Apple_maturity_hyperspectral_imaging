...
channels = 204  # Number of spectral bands
...
# Frmness_encoder_shuffled  = np.load(f'{training_data_path}Side_A_X_train_all_years_Brix_encoder.npy')
...
train_generator = fast_data_generator(X_train_brix, Y_train_brix, Frmness_encoder_shuffled, batch_size, img_size=img_size, band_filter=None)
val_generator = fast_data_generator(X_validate_brix, Y_validate_brix, validate_encoder, batch_size, img_size=img_size, band_filter=None)
