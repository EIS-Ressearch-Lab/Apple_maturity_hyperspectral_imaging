...
checkpoint_brix = tf.keras.callbacks.ModelCheckpoint(
                    filepath=f"{save_file_path}{Code_run_ID}_model_file_brix.keras", 
...
#     model_complex_brix = Sequential()

#     # Convolutional Block 1
#     model_complex_brix.add(
#         Conv2D(64, kernel_size=(2, 2), activation="relu", input_shape=input_shape) # kernal size format is common choice for image data
#     )
#     model_complex_brix.add(BatchNormalization())
#     # model_complex_brix_only.add(MaxPooling2D(pool_size=(2, 2))) # cuts image in half
#     model_complex_brix.add(Dropout(0.25))

#     # Convolutional Block 2
#     model_complex_brix.add(Conv2D(128, kernel_size=(2, 2), activation="relu"))
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(MaxPooling2D(pool_size=(2, 2), padding = 'same'))
#     model_complex_brix.add(Dropout(0.25))

#     # Convolutional Block 3
#     model_complex_brix.add(Conv2D(256, kernel_size=(2, 2), activation="relu"))
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(MaxPooling2D(pool_size=(2, 2), padding = 'same'))
#     model_complex_brix.add(Dropout(0.25))

#     # Convolutional Block 4
#     model_complex_brix.add(Conv2D(512, kernel_size=(2, 2), activation="relu"))
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(MaxPooling2D(pool_size=(2, 2), padding = 'same'))
#     model_complex_brix.add(Dropout(0.25))

#     # Convolutional Block 5
#     model_complex_brix.add(Conv2D(1024, kernel_size=(2, 2), activation="relu"))
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(MaxPooling2D(pool_size=(2, 2), padding = 'same'))
#     model_complex_brix.add(Dropout(0.25))

#     # Convolutional Block 6
#     # model_complex_brix_only.add(Conv2D(2048, kernel_size=(3, 3), activation="relu")) #2048 - number of filters
#     # model_complex_brix_only.add(BatchNormalization())
#     # model_complex_brix_only.add(MaxPooling2D(pool_size=(2, 2), padding = 'same'))
#     # model_complex_brix_only.add(Dropout(0.25))

#     # Global Average Pooling
#     model_complex_brix.add(GlobalAveragePooling2D())

#     # Dense layers
#     model_complex_brix.add(Dense(2048, activation="relu")) # Dense layers other type of extraction method
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(Dropout(0.5))

#     model_complex_brix.add(Dense(1024, activation="relu"))
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(Dropout(0.5))

#     model_complex_brix.add(Dense(512, activation="relu"))
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(Dropout(0.5))

#     model_complex_brix.add(Dense(256, activation="relu"))
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(Dropout(0.5))

#     # Output layer with 1 neuron for regression
#     model_complex_brix.add(Dense(3, activation="linear")) # This dense layer sets number of output nodes
    
#     # Compile the model
#     model_complex_brix.compile(optimizer="adam", loss="mean_squared_error", metrics=["mae"])

# model_complex_brix.summary()
...
#     # Output layer with 1 neuron for regression
#     model_complex_brix.add(Dense(1, activation="linear")) # This dense layer sets number of output nodes
...
#     # Convolutional Block 1
#     model_complex_brix.add(
#         Conv2D(98, kernel_size=(2, 2), activation="relu", input_shape=input_shape) # kernal size format is common choice for image data
#     )
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(MaxPooling2D(pool_size=(2, 2))) # cuts image in half
#     model_complex_brix.add(Dropout(0.307137))

#     # Convolutional Block 2
#     model_complex_brix.add(Conv2D(319, kernel_size=(2, 2), activation="relu"))
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(MaxPooling2D(pool_size=(2, 2), padding = 'same'))
#     model_complex_brix.add(Dropout(0.307137))

#     # Convolutional Block 3
#     model_complex_brix.add(Conv2D(560, kernel_size=(2, 2), activation="relu"))
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(MaxPooling2D(pool_size=(2, 2), padding = 'same'))
#     model_complex_brix.add(Dropout(0.307137))

#     # Convolutional Block 4
#     model_complex_brix.add(Conv2D(474, kernel_size=(2, 2), activation="relu"))
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(MaxPooling2D(pool_size=(2, 2), padding = 'same'))
#     model_complex_brix.add(Dropout(0.307137))
...
#     # # Convolutional Block 6
#     # model_complex_brix.add(Conv2D(2048, kernel_size=(3, 3), activation="relu")) #2048 - number of filters
#     # model_complex_brix.add(BatchNormalization())
#     # model_complex_brix.add(MaxPooling2D(pool_size=(2, 2), padding = 'same'))
#     # model_complex_brix.add(Dropout(0.25))
...
with strategy.scope():
    ...
    # Convolutional Block 1
    model_complex_brix.add(Conv2D(64, kernel_size=(1, 1), activation="relu", input_shape=input_shape))
    model_complex_brix.add(BatchNormalization())
    model_complex_brix.add(MaxPooling2D(pool_size=(1, 1), padding = 'same')) # cuts image in half
    model_complex_brix.add(Dropout(0.15))

    # Convolutional Block 2
    model_complex_brix.add(Conv2D(128, kernel_size=(1, 1), activation="relu"))
    model_complex_brix.add(BatchNormalization())
    model_complex_brix.add(MaxPooling2D(pool_size=(1, 1), padding = 'same'))
    model_complex_brix.add(Dropout(0.15))

    # Convolutional Block 3
    model_complex_brix.add(Conv2D(256, kernel_size=(1, 1), activation="relu"))
    model_complex_brix.add(BatchNormalization())
    model_complex_brix.add(MaxPooling2D(pool_size=(1, 1), padding = 'same'))
    model_complex_brix.add(Dropout(0.15))

    # # Convolutional Block 4
    # model_complex_brix.add(Conv2D(512, kernel_size=(4, 4), activation="relu"))
    # model_complex_brix.add(BatchNormalization())
    # model_complex_brix.add(MaxPooling2D(pool_size=(4, 4), padding = 'same'))
    # model_complex_brix.add(Dropout(0.15))
    ...
    model_complex_brix.add(Dense(1048, activation="relu"))
    model_complex_brix.add(BatchNormalization())
    model_complex_brix.add(Dropout(0.5))
...
#     # Convolutional Block 1
#     model_complex_brix.add(
#         Conv2D(122, kernel_size=(1, 1), activation="relu", input_shape=input_shape) # kernal size format is common choice for image data
#     )
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(MaxPooling2D(pool_size=(1, 1), padding = 'same')) 
#     model_complex_brix.add(Dropout(0.269597))

#     # # Convolutional Block 2
#     # model_complex_brix.add(Conv2D(653, kernel_size=(3, 3), activation="relu"))
#     # model_complex_brix.add(BatchNormalization())
#     # model_complex_brix.add(MaxPooling2D(pool_size=(1, 1), padding = 'same'))
#     # model_complex_brix.add(Dropout(0.48062037315163353))

#     # # Convolutional Block 3
#     # model_complex_brix.add(Conv2D(1306, kernel_size=(3, 3), activation="relu"))
#     # model_complex_brix.add(BatchNormalization())
#     # model_complex_brix.add(MaxPooling2D(pool_size=(1, 1), padding = 'same'))
#     # model_complex_brix.add(Dropout(0.48062037315163353))

#     # # Convolutional Block 4
#     # model_complex_brix.add(Conv2D(2612, kernel_size=(3, 3), activation="relu"))
#     # model_complex_brix.add(BatchNormalization())
#     # model_complex_brix.add(MaxPooling2D(pool_size=(1, 1), padding = 'same'))
#     # model_complex_brix.add(Dropout(0.48062037315163353))
...
#     model_complex_brix.add(Dense(258, activation="relu"))
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(Dropout(0.5))

#     model_complex_brix.add(Dense(128, activation="relu"))
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(Dropout(0.5))
...
#     # Compile the model
#     model_complex_brix.compile(optimizer=tf.keras.optimizers.Adam(), loss="mean_squared_error", metrics=["mae"]
...
csv_logger = CSVLogger(f"{save_file_path}{Code_run_ID}history_brix.csv", append=True)


# In[ ]:


train_generator = data_generator_w_cultivar(X_train_brix, Y_train_brix, Brix_encoder_shuffled, batch_size, img_size, hotencoding=True)
val_generator = data_generator_w_cultivar(X_validate_brix, Y_validate_brix, validate_encoder, batch_size, img_size, hotencoding=True)


# In[ ]:


model_complex_brix.fit(train_generator,epochs=110,steps_per_epoch=len(X_train_brix) // batch_size,validation_data=val_generator,validation_steps=len(X_validate_brix) // batch_size,callbacks=[tf.keras.callbacks.CSVLogger(f"{save_file_path}{Code_run_ID}history_brix.csv", append=True), checkpoint_brix],)


# In[ ]:


# model_complex_brix.save(f'{save_file_path}{Code_run_ID}_{today}model_trained_100epoch_brix.keras')


# In[ ]:


del model_complex_brix
gc.collect()
