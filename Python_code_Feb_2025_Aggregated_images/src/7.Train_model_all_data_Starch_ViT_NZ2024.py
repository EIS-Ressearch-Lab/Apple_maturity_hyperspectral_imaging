...
X_train_Starch          = np.load(f'{training_data_path}X_train_NZ2024_Starch_shuffled.npy')
Y_train_Starch          = np.load(f'{training_data_path}Y_train_NZ2024_Starch_shuffled.npy')
X_validate_Starch       = np.load(f'{training_data_path}X_validate_NZ2024_Starch_shuffled.npy')
Y_validate_Starch       = np.load(f'{training_data_path}Y_validate_NZ2024_Starch_shuffled.npy')
Frmness_encoder_shuffled  = np.load(f'{training_data_path}X_train_NZ2024_Starch_encoder_shuffled.npy')
validate_encoder        = np.load(f'{training_data_path}X_validate_NZ2024_Starch_encoder_shuffled.npy')
...
# 使用数据增强的训练生成器
train_generator = data_generator_w_cultivar(X_train_Starch, Y_train_Starch, Frmness_encoder_shuffled, batch_size, img_size=img_size)
