...
# files_UK2024_d = pd.read_pickle(f'{pickle_path}aggregated_files_UK2024_d.pkl')

# file_name = files_UK2024_d.iloc[66]['img_ID']

# # original

# Folder_path_UK2024 = '/media/2tbdisk2/data/Haidee_apple_data/Haidee/Hyperspectral_images/spectral_UK_2024/'
# side = 'd'
# spectral_link = Folder_path_UK2024 + files_UK2024_d.iloc[66]['Spectral_folder_d']
# dat_files = glob.glob(f"{spectral_link}/results/*.dat")
# print(dat_files)
...
# x1, y1, x2, y2 = files_UK2024_d.iloc[66]["sorted_tensor"][2]
...
# test_img = np.load(f"{spectral_folder_path}UK2024/30px_{file_name}.npy")
