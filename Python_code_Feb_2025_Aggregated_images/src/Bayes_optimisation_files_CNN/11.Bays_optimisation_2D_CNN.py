...
img_size = 40
Code_run_ID = today + 'run_29_2D_CNN_bays_opt_40px'
...
filters1 = Integer(32, 128, name="filters1")  # Filters for first Conv2D layer  
...
if testing == True:
    ...
    search_space = [
        ...
        Integer(8, 9, name="filters1"),
        Integer(3, 4, name="filters2"),
        Integer(3, 4, name="filters3"),
        Integer(3, 4, name="filters4"),
        Integer(3, 4, name="filters5"),
        Integer(2, 3, name="kernel_size"),
        Real(0.15, 0.16, name="dropout"),
...
for dat_type in data_type:
    ...
    path_best_model = f'/home/ht21074/Auto_box_apples/Auto_box_apples/Source_folder/Bayesian_optimisation_files/Bayes_opt_2026/{Code_run_ID}_2D_CNN_best_model_params_{dat_type}.keras'

    X_train, y_train, X_val, y_val, train_cultivars, validate_encoder = load_data(dat_type)

    
    model_checkpoint_cb = tf.keras.callbacks.ModelCheckpoint(
                        filepath=f"{save_file_path}_{Code_run_ID}_model_file_{dat_type}_2DCNN.keras", 
    ...
    checkpoint_path = f"{training_data_path}{Code_run_ID}_2D_CNN_bayesian_optimization_checkpoint_{dat_type}.pkl"
    ...
    with tqdm(total=n_calls, desc="Optimisation Progress") as pbar:
        try: 
            ...
            df_results.to_excel(f"{training_data_path}{Code_run_ID}_2D_CNN_bayesian_optimization_results_{dat_type}.xlsx", index=False)
            df_results.to_pickle(f"{training_data_path}{Code_run_ID}_2D_CNN_bayesian_optimization_results_{dat_type}.pkl")
