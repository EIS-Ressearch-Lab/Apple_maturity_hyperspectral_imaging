...
train_generator = data_generator_w_cultivar(X_train_Starch, Y_train_Starch, Starch_encoder_shuffled, batch_size, img_size)
val_generator = data_generator_w_cultivar(X_validate_Starch, Y_validate_Starch, validate_encoder, batch_size, img_size)
