...
validation_file_path = '/home/ht21074/Auto_box_apples/Auto_box_apples/Source_folder/Training_data_May2025/50px/'
...
def load_data(data_type):
    if data_type == 'brix':
        ...
        X_train = np.load(f'{training_data_path}X_train_brix_optimisation_May2025_SideA.npy')
        y_train = np.load(f'{training_data_path}Y_train_brix_optimisation_May2025_SideA.npy')                     
        X_val= np.load(f'{validation_file_path}Side_A_X_validate_all_years_Brix_shuffled.npy')                 
        y_val= np.load(f'{validation_file_path}Side_A_Y_validate_all_years_Brix_shuffled.npy')                
        train_cultivars = np.load(f'{training_data_path}X_encoder_brix_optimisation_May2025_SideA.npy')   
        validate_encoder = np.load(f'{validation_file_path}Side_A_X_validate_all_years_Brix_encoder.npy') # This is shuffled data
        ...
        # Side A
        X_train = np.load(f'{training_data_path}X_train_firmness_optimisation_May2025_SideA.npy')
        y_train = np.load(f'{training_data_path}Y_train_firmness_optimisation_May2025_SideA.npy')                     
        X_val= np.load(f'{validation_file_path}Side_A_X_validate_all_years_Firmness_shuffled.npy')                  
        y_val= np.load(f'{validation_file_path}Side_A_Y_validate_all_years_Firmness_shuffled.npy')                
        train_cultivars = np.load(f'{training_data_path}X_encoder_firmness_optimisation_May2025_SideA.npy')   
        validate_encoder = np.load(f'{validation_file_path}Side_A_X_validate_all_years_Firmness_encoder.npy') # This is shuffled data
        ...
        X_train = np.load(f'{training_data_path}X_train_starch_optimisation_May2025_SideA.npy')
        y_train = np.load(f'{training_data_path}Y_train_starch_optimisation_May2025_SideA.npy')                     
        X_val= np.load(f'{validation_file_path}Side_A_X_validate_all_years_Starch_shuffled.npy')                  
        y_val= np.load(f'{validation_file_path}Side_A_Y_validate_all_years_Starch_shuffled.npy')                
        train_cultivars = np.load(f'{training_data_path}X_encoder_starch_optimisation_May2025_SideA.npy')   
        validate_encoder = np.load(f'{validation_file_path}Side_A_X_validate_all_years_Starch_encoder.npy') # This is shuffled data
...
# default_params = [2, 24, 64, 256, 256, 256, 2, 0.1, 1]
...
def evaluate_model(num_layers, filters1, filters2, filters3, filters4, filters5, kernel_size, dropout, pool_size):
    global best_loss
...
for type in data_type:
    ...
    with tqdm(total=n_calls, desc="Optimisation Progress") as pbar:
        try: 
            ...
            df_results.to_excel(f"{training_data_path}bayesian_optimization_results_{type}_sideA.xlsx", index=False)
