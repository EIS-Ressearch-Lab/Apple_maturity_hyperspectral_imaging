...
# 使用数据增强的训练生成器
train_generator = data_generator_w_cultivar(X_train_Starch, Y_train_Starch, Frmness_encoder_shuffled, batch_size, img_size=img_size, band_filter=selected_features_threshold_starch )
val_generator = data_generator_w_cultivar(X_validate_Starch, Y_validate_Starch, validate_encoder, batch_size, img_size=img_size, band_filter=selected_features_threshold_starch)
