...
img_size = 30
Code_run_ID = today + f'run2_{img_size}px'
...
#     # model_complex_brix.add(Conv2D(1024, kernel_size=(2, 2), activation="relu"))
#     # model_complex_brix.add(BatchNormalization())
#     # model_complex_brix.add(MaxPooling2D(pool_size=(2, 2), strides=(1,1), padding = 'same'))
#     # model_complex_brix.add(Dropout(0.25))
...
#     # Convolutional Block 1
#     model_complex_brix.add(
#         Conv2D(64, kernel_size=(1, 1), activation="relu", input_shape=input_shape) # kernal size format is common choice for image data
#     )
#     model_complex_brix.add(BatchNormalization())
#     model_complex_brix.add(MaxPooling2D(pool_size=(1, 1), strides=(1,1), padding = 'same')) # cuts image in half
...
train_generator = data_generator_w_cultivar(X_train_brix, Y_train_brix, Brix_encoder_shuffled, batch_size, img_size)
val_generator = data_generator_w_cultivar(X_validate_brix, Y_validate_brix, validate_encoder, batch_size, img_size)
