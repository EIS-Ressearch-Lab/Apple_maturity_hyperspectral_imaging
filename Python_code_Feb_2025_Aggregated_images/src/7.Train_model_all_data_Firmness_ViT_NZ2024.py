...
img_size = 40
Code_run_ID = today + f'run_18ViT_NZ2024_{img_size}px'
...
X_train_Firmness          = np.load(f'{training_data_path}X_train_NZ2024_Firmness_shuffled.npy')
Y_train_Firmness          = np.load(f'{training_data_path}Y_train_NZ2024_Firmness_shuffled.npy')
X_validate_Firmness       = np.load(f'{training_data_path}X_validate_NZ2024_Firmness_shuffled.npy')
Y_validate_Firmness       = np.load(f'{training_data_path}Y_validate_NZ2024_Firmness_shuffled.npy')
Frmness_encoder_shuffled  = np.load(f'{training_data_path}X_train_NZ2024_Firmness_encoder_shuffled.npy')
validate_encoder        = np.load(f'{training_data_path}X_validate_NZ2024_Firmness_encoder_shuffled.npy')
