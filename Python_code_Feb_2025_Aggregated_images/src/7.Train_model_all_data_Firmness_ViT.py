...
# 使用数据增强的训练生成器
train_generator = fast_data_generator(X_train_Firmness, Y_train_Firmness, Frmness_encoder_shuffled, batch_size, img_size=img_size, band_filter=None)
val_generator = fast_data_generator(X_validate_Firmness, Y_validate_Firmness, validate_encoder, batch_size, img_size=img_size, band_filter=None)
...
# Debug: Check the shape of the first batch from the train_generator
